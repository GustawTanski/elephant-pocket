...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.persistanceService.save(user)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.persistanceService.delete(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserRepository.prototype.findOneByEmail = function (email) {
