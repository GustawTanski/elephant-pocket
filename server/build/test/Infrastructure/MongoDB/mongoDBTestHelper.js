...
exports.mongoBeforeAll = mongoBeforeAll;
function mongoAfterAll(model) {
    var _this = this;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [4 /*yield*/, mongoose_1.default.connection.close()];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
...
exports.mongoAfterAll = mongoAfterAll;
